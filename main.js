...
const config = {
  ...
  if(username !== undefined) {
    ...
    logger('Bạn đang dùng Replit thường, hệ thống sẽ tự động kết nối với Uptime Kuma cho bạn!', '[ CHECK HOST ]');
...
catch { logger.loader("Không thể load được file config.json!", "error") }
